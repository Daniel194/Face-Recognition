...
parametri.numarExempleNegative = 13700;          %numarul exemplelor negative
...
if parametri.antrenareCuExemplePuternicNegative == 1
    try
        ...
        save(numeFisierDescriptoriExemplePuternicNegative,'descriptoriExemplePuternicNegative','-v7.3');
         disp(['Am salvat descriptorii pentru exemplele puternic negative in fisierul ' numeFisierDescriptoriExempleNegative]);
    end
